...
import 'package:nrideapp/features/profile/widgets/profile_item_widget.dart';
import 'package:nrideapp/features/profile/widgets/profile_type_button_widget.dart';
              ...
              child: SingleChildScrollView(child: Column(children: [
                Container(
                  ...
                  child: ClipRRect(borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                    ...
                    ImageWidget(width: 80,height: 80,
                      image:
                      '${Get.find<SplashController>().config!.imageBaseUrl!.vehicleModel}/''${
