...
import 'package:nrideapp/helper/pusher_helper.dart';
import 'package:nrideapp/helper/route_helper.dart';
import 'package:nrideapp/features/auth/controllers/auth_controller.dart';
import 'package:nrideapp/features/location/screens/access_location_screen.dart';
...
import 'package:nrideapp/features/ride/domain/models/final_fare_model.dart';
import 'package:nrideapp/features/ride/domain/models/on_going_trip_model.dart';
import 'package:nrideapp/features/ride/domain/models/parcel_list_model.dart';
import 'package:nrideapp/features/ride/domain/models/pending_ride_request_model.dart';
import 'package:nrideapp/features/ride/domain/models/remaining_distance_model.dart';
import 'package:nrideapp/features/ride/domain/models/trip_details_model.dart';
import 'package:nrideapp/features/trip/screens/payment_received_screen.dart';
...
class RideController extends GetxController implements GetxService{
  ...
  Future<Response> getCurrentRideStatus({bool fromRefresh = false, froDetails = false, isUpdate = true}) async {
    isLoading = true;
    if(froDetails){
      getResult = true;
  ...
  Future<Response> tripStatusUpdate(String status,String id, String message, String cancellationCause) async {
    isLoading = true;
    update();
    Response response = await rideServiceInterface.tripStatusUpdate(status, id,cancellationCause);
