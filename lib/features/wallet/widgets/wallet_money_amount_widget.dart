...
import 'package:nrideapp/features/wallet/widgets/payable_history_widget.dart';
import 'package:nrideapp/features/wallet/widgets/point_to_wallet_money_widget.dart';
...
import 'package:nrideapp/features/wallet/widgets/withdraw_dialog_widget.dart';
              ...
              onTap: (){
                if(walletController.walletTypeIndex == 1){
                  ...
                  showModalBottomSheet(
                    context: context,
                    isScrollControlled: true,
                    builder: (_) => SizedBox(height: Get.height * 0.8,
                      child: const PayableHistoryWidget(),
                    ),
                  );
                }
              },
